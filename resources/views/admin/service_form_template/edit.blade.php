    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form class="custom-validation outer-repeater" action="{{ route('service-form-template.update',$template->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <div>
                                            <input data-parsley-type="text" type="text" class="form-control" placeholder="Template Name" name="template_name" value="{{ $template->template_name }}">
                                        </div>
                                    </div>
                                    <hr>
                                    <table width="100%" cellpadding="5" cellspacing="5" id="table_repeter">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ $fields->label_name }}<br>
                                                @if($fields->input_type == 'select' || $fields->input_type == 'radio' || $fields->input_type == 'checkbox' )
                                                Options : {{ $fields->input_type_options }}
                                                @endif
                                            </td>
                                            <td>
                                                @if($fields->input_is_required == 1) Yes @else No @endif
                                            </td>
                                            <td>
                                                @if($fields->input_is_readonly == 1) Yes @else No @endif
                                            </td>
                                            <td>
                                                <a  href="{{ route('service-form-template.delete-form-field',$fields->id) }}" onclick="return confirm('Are You sure?')" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove this Item"><i class="ti-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </table>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="customRadioInline1" name="is_visible" class="form-check-input" value="1" {{ check_uncheck($template->is_visible,1) }}>
                                            <label class="form-check-label" for="customRadioInline1">Show</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="customRadioInline2" name="is_visible" class="form-check-input" value="0" {{ check_uncheck($template->is_visible,0) }}>
