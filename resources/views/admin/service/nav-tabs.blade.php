<ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
    <li class="nav-item">
        <a class="nav-link {{ request()->segment(3) == 'basic-info' ? 'active' : '' }}" href="{{ route('service.basic-info') }}" role="tab">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->segment(3) == 'price-edit' ? 'active' : '' }}"  href="{{ route('service.edit-price-info',request()->segment(4)) }}" role="tab">
