    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <!-- end page title -->
                <form action="{{ route('service.edit-basic-info-store') }}" method="post" enctype="multipart/form-data">
                @csrf
                                        ...
                                        <div class="card-body row">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <div>
                                                        <input data-parsley-type="text" type="text" class="form-control" value="{{ $service->service_time }}" required placeholder="Enter Service Time Ex : 1 hour" name="service_time">
                                                    </div>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                            ...
                                            <div id="service-survey-required" style="display: @if($service->service_types == 'surveyRequired') block @else none @endif">
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <select class="select2 form-control select2-multiple" name="time_slot[]" multiple="multiple" multiple data-placeholder="Choose ...">
                                                        ...
                                                        <option @if(in_array($slot->id,$times)) selected @endif value="{{ $slot->id }}">{{ formated_time($slot->start_time) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
