    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('service-type.index') }}">{{ $title }}</a></li>
                        ...
                        <div class="col-md-4">
                            <div class="float-end d-none d-md-block">
                                <div class="dropdown">
                                    <a href="{{ route('service-type.index') }}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
                ...
                <!-- end page title -->
                <form class="custom-validation" action="{{ route('service-type.update',$type->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <div>
                                            <textarea class="editor" name="description">{{ $type->description }}</textarea>
                                        </div>    
                                    </div>
                                </div>
                            </div>
