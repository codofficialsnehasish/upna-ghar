    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('apartment-type.index') }}">{{ $title }}</a></li>
                        ...
                        <div class="col-md-4">
                            <div class="float-end d-none d-md-block">
                                <div class="dropdown">
                                    <a href="{{ route('apartment-type.index') }}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
                ...
                <!-- end page title -->
                <form class="custom-validation" action="{{ route('apartment-type.update',$type->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-9">
