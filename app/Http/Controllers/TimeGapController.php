...
use App\Models\TimeGap;
use Illuminate\Http\Request;

class TimeGapController extends Controller
{
    public function __construct(){
        $this->view_path = 'admin.master_data.time_gap.';
    }

    public function index()
    {
        $data['title'] = 'Time Gap';
        $data['types'] = TimeGap::all();
    ...
    {
        $type = new TimeGap();
        $type->time_gap = $request->time_gap;
