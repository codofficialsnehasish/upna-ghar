                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <a href="{{route('slider.add')}}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$s->title}}</td>
                                                    <td>
                                                        <img src="{{ asset($s->image) }}" width="50">
                                                    </td>
                                                    <td>
                                                        @if($s->is_visible==1)
                                                    ...
                                                    <td>
                                                        <a class="btn btn-success mr-2" href="{{route('slider.edit',$s->id)}}" alt="edit"><i class="ti-check-box"></i></a>
                                                        <a class="btn btn-danger" onclick="return confirm('Are you sure?')" href="{{route('slider.delete',$s->id)}}"><i class="ti-trash"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
